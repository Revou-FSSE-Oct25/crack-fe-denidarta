							...
							<section className={styles.section}>
								...
								<div className={styles.fieldGrid}>
									...
									<Field
										...
										value={String(studentProfile.enrollmentYear)}
									/>
									...
									<Field
										...
										value={
											studentProfile.currentSemester != null
												? String(studentProfile.currentSemester)
												: null
										}
									/>
									<Field
										...
										value={
											studentProfile.gpa != null
												? Number(studentProfile.gpa).toFixed(2)
												: null
										}
									/>
									<Field
										...
										value={
											ACADEMIC_STATUS_LABELS[studentProfile.academicStatus] ??
