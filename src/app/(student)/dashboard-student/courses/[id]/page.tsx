...
export default function StudentCourseDetailPage() {
	...
	if (courseLoading)
		return <Loading withOverlay={false} description="Loading course..." />;
		...
		<div className={styles.container}>
			...
			<div className={styles.header}>
				...
				<div className={styles.meta}>
					...
					<Tag type={statusTagType(course.status)} size="sm">
						{course.status}
					</Tag>
				</div>
			</div>
												...
												<TableRow {...getRowProps({ row })} key={row.id}>
													{row.cells.map((cell) => {
														if (
															...
															cell.info.header === "attendance"
														) {
															const val = String(cell.value);
															return (
																<TableCell key={cell.id}>
																	<Tag type={statusTagType(val)} size="sm">
																		{val}
																	</Tag>
																</TableCell>
															);
														...
														if (cell.info.header === "location") {
															const isUrl = String(cell.value).startsWith(
																"http",
															);
															return (
																<TableCell key={cell.id}>
														...
														return (
															<TableCell key={cell.id}>
																<Button
																	...
																	onClick={() =>
																		router.push(
																			`/dashboard-student/assignments/${row.id}`,
																		)
																	}
