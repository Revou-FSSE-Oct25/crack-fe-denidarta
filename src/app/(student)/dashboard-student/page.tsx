    ...
    <div className={styles.container}>
      ...
      <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap", marginBottom: "2rem" }}>
        ...
        <StatTile
          ...
          subtitle={stats.totalSessions > 0 ? `${stats.totalSessions} sessions` : "no sessions yet"}
        />
      </div>
      ...
      {coursesError && (
        <InlineNotification
          kind="error"
          title="Error"
          subtitle={coursesError instanceof Error ? coursesError.message : "Failed to load courses"}
          lowContrast
