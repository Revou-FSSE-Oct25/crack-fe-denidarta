		...
		<div className={styles.wrapper}>
			<div className={styles.leftPanel}>
				...
				<div className={styles.header}>
					...
					<p>You were invited! Set a password to activate your account and start learning.</p>
				</div>
				...
				<Form onSubmit={onSubmit} noValidate className={styles.form}>
					<Stack gap={0}>
						...
						<div className={styles.fieldGroup}>
							...
							<p className={styles.helperText}>Filled automatically from your invitation link.</p>
						</div>
				...
				<div className={styles.rightInner}>
					...
					<div className={styles.quoteBlock}>
						<p className={styles.quoteText}>
							&ldquo;Learning is not attained by chance, it must be sought for with ardor and attended to
							with diligence.&rdquo;
						</p>
