...
const testimonials = [
  {
    quote: '"LearnOS reduced our onboarding time by 40%. Every new hire is fully productive two weeks faster than before."',
    name: 'Sarah Chen',
    role: 'Head of L&D · Meridian Corp',
  },
  {
    quote: '"The compliance tracking alone saved our legal team 20+ hours a month. It just works exactly the way we need."',
    name: 'Marcus Williams',
    role: 'VP Operations · Nexus Financial',
  },
  {
    quote: '"We scaled from 200 to 8,000 learners without touching the infrastructure. The platform just grew with us."',
    name: 'Priya Nair',
    ...
    <div className={styles.page}>
      ...
      <nav className={styles.nav}>
        <div className={styles.navInner}>
          <div className={styles.navLogo}>
            ...
            <span className={styles.navLogoText}>LearnOS</span>
          </div>

          <div className={styles.navLinks}>
            <a href="#features" className={styles.navLink}>Platform</a>
            <a href="#how"      className={styles.navLink}>Solutions</a>
          ...
          <div className={styles.navActions}>
            ...
            <Button kind="primary" size="sm" href="/login">Get Started</Button>
          </div>
        </div>
      </nav>
      ...
      <section className={styles.hero}>
        <div className={styles.heroLeft}>
          <div className={styles.heroBadge}>
            ...
            <span className={styles.heroBadgeText}>Enterprise Learning Platform</span>
          </div>
          ...
          <p className={styles.heroSubline}>
            Deliver structured, measurable learning experiences at enterprise scale.
            Track progress, certify skills, and close knowledge gaps — all in one unified platform.
          </p>

          <div className={styles.heroCTAs}>
            <Button kind="primary" size="lg" href="/login">Start Free Trial</Button>
            <Button kind="secondary" size="lg">Request Demo →</Button>
          </div>
        </div>
        ...
        <div className={styles.featHeader}>
          <div className={styles.featHeaderLeft}>
            ...
            <h2 className={styles.sectionTitle}>
              Everything you need to<br />build a learning culture
            </h2>
          </div>
      ...
      <section id="how" className={styles.howItWorks}>
        <div>
          ...
          <h2 className={styles.sectionTitle} style={{ marginTop: '1rem' }}>
            From setup to scale<br />in three steps
          </h2>
        </div>
      ...
      <section id="pricing" className={styles.pricing}>
        ...
        <div className={styles.pricingCards}>
          ...
          <div className={styles.pricingCard}>
            <span className={`${styles.planLabel} ${styles.planLabelMuted}`}>Starter</span>
            ...
            <div className={styles.planFeatures}>
              {['Up to 50 learners', '20 courses included', 'Basic analytics', 'Email support'].map((f) => (
                <span key={f} className={`${styles.planFeature} ${styles.planFeatureMuted}`}>{f}</span>
              ))}
            </div>
            <Button kind="secondary" size="md">Get Started</Button>
          </div>
          ...
          <div className={`${styles.pricingCard} ${styles.pricingCardFeatured}`}>
            ...
            <div className={styles.priceRow}>
              <span className={`${styles.priceNum} ${styles.priceNumWhite}`}>$149</span>
              <span className={`${styles.pricePer} ${styles.pricePerBlue}`}>/mo</span>
            </div>
            <p className={`${styles.planDesc} ${styles.planDescBlue}`}>
              For growing teams with serious learning objectives.
            </p>
            <div className={`${styles.pricingDivider} ${styles.pricingDividerBlue}`} />
            <div className={styles.planFeatures}>
              {['Up to 500 learners', 'Unlimited courses', 'Advanced analytics', 'Priority support', 'Custom branding'].map((f) => (
                <span key={f} className={`${styles.planFeature} ${styles.planFeatureWhite}`}>{f}</span>
              ))}
            </div>
            <Button kind="tertiary" size="md" style={{ background: '#fff', color: '#0f62fe', borderColor: '#fff' }}>
              Get Started
            </Button>
          </div>
          ...
          {/* Enterprise */}
          <div className={styles.pricingCard}>
            <span className={`${styles.planLabel} ${styles.planLabelMuted}`}>Enterprise</span>
            <span className={styles.priceNumCustom}>Custom</span>
            <p className={`${styles.planDesc} ${styles.planDescMuted}`}>
              For large organizations requiring full control, compliance, and dedicated support.
            </p>
            <div className={styles.pricingDivider} />
            <div className={styles.planFeatures}>
              {['Unlimited learners', 'SSO & SCIM provisioning', 'Dedicated CSM', 'SLA guarantees'].map((f) => (
                <span key={f} className={`${styles.planFeature} ${styles.planFeatureMuted}`}>{f}</span>
              ))}
            </div>
            <Button kind="secondary" size="md">Contact Sales</Button>
          </div>
        </div>
      </section>
      ...
      <section className={styles.finalCta}>
        <div className={styles.ctaLeft}>
          <h2 className={styles.ctaTitle}>
            Ready to transform<br />how your team learns?
          </h2>
          <p className={styles.ctaSub}>
            Join 2,400+ organizations already using LearnOS. No setup fees. Cancel anytime.
          </p>
          <div className={styles.ctaButtons}>
            <Button kind="tertiary" size="lg" style={{ background: '#fff', color: '#0f62fe', borderColor: '#fff' }}>
              Start Free Trial
            </Button>
            <Button kind="ghost" size="lg" style={{ color: '#fff', borderColor: '#fff' }}>
              Talk to Sales →
            </Button>
          </div>
        </div>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerTop}>
          <div className={styles.footerBrand}>
            ...
            <p className={styles.footerTagline}>
              The enterprise learning platform built for teams that move fast and need to stay sharp.
            </p>
          </div>
          ...
          <div className={styles.footerLinks}>
            <div className={styles.footerCol}>
              ...
              {['Features', 'Integrations', 'Pricing', 'Changelog'].map((l) => (
                <a key={l} href="#" className={styles.footerColLink}>{l}</a>
              ))}
            </div>
            <div className={styles.footerCol}>
            ...
            <div className={styles.footerCol}>
              ...
              {['Documentation', 'API Reference', 'Community', 'Status'].map((l) => (
                <a key={l} href="#" className={styles.footerColLink}>{l}</a>
              ))}
            </div>
          </div>
        ...
        <div className={styles.footerBottom}>
          <span className={styles.footerCopy}>© 2025 LearnOS Inc. All rights reserved.</span>
          <div className={styles.footerBottomLinks}>
            {['Privacy Policy', 'Terms of Service', 'Security'].map((l) => (
              <a key={l} href="#" className={styles.footerBottomLink}>{l}</a>
            ))}
          </div>
        </div>
      </footer>
