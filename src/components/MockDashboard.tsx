			...
			<Grid fullWidth>
				...
				<Column sm={4} md={8} lg={16} style={{marginTop: '0.75rem'}}>
					<div style={{
						...
						<div>
							<h1 style={{margin: 0, fontSize: '1.75rem', lineHeight: 1.2}}>Operations dashboard</h1>
				...
				{kpis.map ((kpi) => (
					<Column key={kpi.label} sm={4} md={4} lg={4} style={{marginTop: '1rem'}}>
						<Tile>
							<div style={{
								display: 'flex',
								alignItems: 'center',
								...
								<Tag type={kpi.delta.startsWith ('-') ? 'red' : 'green'} size="sm">
									{kpi.delta}
								</Tag>
							</div>
						</Tile>
				...
				<Column sm={4} md={8} lg={10} style={{marginTop: '1rem'}}>
					<Tile>
						<div style={{
							...
							<div>
								<h2 style={{margin: 0, fontSize: '1.125rem'}}>Recent activity</h2>
								<p style={{margin: '0.25rem 0 0', color: 'var(--cds-text-secondary)'}}>Latest tickets
									and requests.</p>
							</div>
							<div style={{display: 'flex', gap: '0.5rem', alignItems: 'center'}}>
								<Search size="md" labelText="Search" placeholder="Search"/>
								<Button kind="ghost" size="md" hasIconOnly iconDescription="Filter"
								        renderIcon={Filter}/>
							</div>
						</div>
				...
				<Column sm={4} md={8} lg={6} style={{marginTop: '1rem'}}>
					<Tile>
						...
						<p style={{margin: '0.25rem 0 0', color: 'var(--cds-text-secondary)'}}>Placeholder panel for
							charts.</p>
						<div
							style={{
								marginTop: '1rem',
